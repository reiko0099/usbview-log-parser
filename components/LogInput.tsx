...
const LogInput: React.FC<LogInputProps> = ({ logText, onLogChange, onParse, onClear, onLoadSample, isLoading }) => {
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col h-full">
      ...
      <textarea
        ...
        placeholder="Paste your USBView log here..."
        value={logText}
      ...
      <div className="mt-4 flex flex-wrap gap-4">
        <button
          ...
          className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-md transition-colors duration-300 disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
        ...
        <button
          ...
          className="flex-1 bg-teal-500 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded-md transition-colors duration-300"
        >
          Load Sample
        </button>
      </div>
